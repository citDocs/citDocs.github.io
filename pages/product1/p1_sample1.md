...
Примечание. Если удалить содержимое нескольких ячеек, чтобы изменить адрес перекрестка после нажатия CTRL+END. Но после удаления нужно обязательно сохранить файл. Иначе CTRL+END будет возвращать курсор по старому адресу.
...
Если нужно заполнить строку ячеек с лева на право, то после каждого ввода жмем клавишу на клавиатуре «Tab». А если мы заполняем строку справа налево, то тогда – SHIFT+ Tab.
...
<ol>
    <li>На чистом листе в ячейку А1 введите текущею дату нажав CTRL+;.</li>
...
_Примечание. С помощью формата ячеек мы настраиваем способ отображения их значений. Например, например можно добавить или убрать время из даты в Excel._
...
_Примечание. Данная функция автоматически подставляет формат ячеек которых она суммирует._
...
<ol>
    ...
    <li>
        На этот рас нам не подходит автоматическое определение диапазона ячеек, поэтому его нужно исправить на D2:D4. После чего жмем Enter.
    </li>
    <li>
...
<ol>
    ...
    <li>
        Щелкните по графику чтобы активировать его и вызвать дополнительное меню «Работа с диаграммами». Там же доступны три закладки инструментов: «Конструктор», «Макет», «Формат».
        ![картинка](/images/img11.png)
    </li>
    <li>
...
<ol>
    <li>
        Щелкните левой кнопкой мышки по графику, чтобы активировать его (выделить) и выберите инструмент: «Работа с диаграммами»-«Макет»-«Легенда».
    </li>
    <li>
...
<ol>
    <li>
        Активируйте график щелкнув по нему и выберите инструмент «Работа с диаграммами»-«Макет»-«Таблица данных».
    </li>
    <li>
...
<ol>
    ...
    <li>
        Щелкните правой кнопкой мышки по первому столбцу для вызова контекстного меню и выберите опцию «Формат точки данных».
        ![картинка](/images/img11.png)
    </li>
    <li>
        В диалоговом окне «Формат точки данных» в левом отделе выберите опцию «Заливка», а в правом отделе надо отметить пункт «Градиентная заливка».
    </li>
</ol>
